...
const clients = [
  ...
  { name: "Subros", location: "Manesar & Karsanpura", logo: "https://www.subros.com/public/upload/logo/20241221112238.webp" },
  { name: "IFB", location: "Binola & Kolkata", logo: "https://www.ifbappliances.com/content/dam/ifbindustrieslimitedprogram/icons/ifb-logo.svg" },
  { name: "Alicon", location: "Binola", logo: aliconLogo },
  { name: "Munjal Kiriu", location: "Manesar", logo: "https://munjalkiriu.co.in/wp-content/uploads/2020/03/logo.png" },
  { name: "Amem", location: "Bhiwadi", logo: "https://www.anandgroupindia.com/wp-content/uploads/2021/08/amem-new.png" },
  { name: "Anchemco", location: "Parwanoo", logo: "https://www.anandgroupindia.com/wp-content/uploads/2019/05/i-logo.png" },
];

const collaborators = [
  { name: "Unique Controls & Solutions", location: "Kolhapur", logo:"https://www.uniquecontrols.net/images/logo.png" },
                ...
                {clients.map((client, index) => (
                  <Card key={index} className="text-center">
                    <CardContent className="flex flex-col items-center justify-center p-6">
                      ...
                      <p className="mt-2 text-sm text-foreground/70">{client.location}</p>
                      {client.note && <p className="text-xs text-foreground/50">{client.note}</p>}
                    </CardContent>
                  </Card>
                ))}
              </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-6 sm:grid-cols-3 md:grid-cols-4">
                {collaborators.map((collaborator, index) => (
                  <Card key={index} className="text-center">
                    <CardContent className="flex flex-col items-center justify-center p-6">
                      {collaborator.logo ? <img src={collaborator.logo} alt="" /> : <p className="font-bold">{collaborator.name}</p> }
                      <p className="mt-1 text-sm text-foreground/70">{collaborator.location}</p>
                    </CardContent>
                  </Card>
                ))}
              </div>
