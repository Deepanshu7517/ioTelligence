import { createContext, useContext, useMemo, forwardRef } from "preact/compat"
...
interface ChartTooltipContentProps extends JSX.HTMLAttributes<HTMLDivElement> {
  ...
  labelKey?: string
  label?: string
  labelFormatter?: (value: any, payload: any[]) => ComponentChildren
  labelClassName?: string
  formatter?: (value: any, name: string, item: any, index: number, payload: any) => ComponentChildren
  color?: string
}
